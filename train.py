...
def getParameters():
    ...
    # general settings
    parser.add_argument('-v', '--version', type=str, default='MGDUN_X4_ixi', help="version name for train, finetune")
    parser.add_argument('--train_yaml', type=str, default="train_MGDUN_X4_ixi.yaml")
...
def main():
    ...
    # moduleName = "train_scripts.trainer_common"
