...
# os.makedirs(train_LR_PD, exist_ok=True)
...
os.makedirs(os.path.join(train_LR_PD,'X2'),exist_ok=True)
os.makedirs(os.path.join(train_LR_PD,'X4'),exist_ok=True)
os.makedirs(os.path.join(val_LR_PD,'X2'),exist_ok=True)
os.makedirs(os.path.join(val_LR_PD,'X4'),exist_ok=True)
os.makedirs(os.path.join(test_LR_PD,'X2'),exist_ok=True)
os.makedirs(os.path.join(test_LR_PD,'X4'),exist_ok=True)
# train 400
# val 20
# test 81
# normalize to 0-255
...
if __name__ == '__main__':
    # generateLR(HR_path, LR_path)
    generateLR(train_HR_PD, train_LR_PD)
    generateLR(val_HR_PD, val_LR_PD)
    generateLR(test_HR_PD, test_LR_PD)
    # generateImage()
    # val
    # print('create Dataset val hr')
