...
def getParameters():
    ...
    # general settings
    parser.add_argument('-v', '--version', type=str, default='Ours_X4_ixi',
    ...
    parser.add_argument('-s', '--checkpoint_epoch', type=int, default=251,
    ...
    parser.add_argument('--test_dataset_name', type=str, default='ixi',
                        choices=['DIV2K', 'B100', 'Urban100', 'Set5', 'Set14', "Manga109",'ixi'])
